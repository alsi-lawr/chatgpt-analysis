...
def parser() -> argparse.ArgumentParser:
    ...
    prepare = subparsers.add_parser("prepare", help="prepare independent review or adjudication queues")
    prepare.add_argument("--config", type=Path, required=True)
    prepare.add_argument("--kind", choices=("triage", "signals"), required=True)
    prepare.add_argument("--stage", choices=("review", "adjudication"), required=True)
